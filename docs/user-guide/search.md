...
**Settings -> Assets -> Visual search**, then run **Index visual
search**. Smriti stores the model outside the app binary and stores
per-library vectors under `.photovault/semantic`.
